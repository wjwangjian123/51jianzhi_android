 ...
 * @Date :2020-03-26
 **/
public class ActionListAdapter extends CustomBaseAdapter<ActJobListEntity.DataBeanX.DataBean> {

    private Context context;

    public ActionListAdapter(Context context, List<ActJobListEntity.DataBeanX.DataBean> list) {
        super(context, R.layout.item_home_type, list);
        this.context = context;
    }

    @Override
    protected void convert(ViewHolder viewHolder, ActJobListEntity.DataBeanX.DataBean item, int position) {
        if (item != null) {
