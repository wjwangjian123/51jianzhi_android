 ...
 * @Date :2020-03-26
 **/
public class SearchListAdapter extends CustomBaseAdapter<SearchEntity.DataBean> {

    private Context context;

    public SearchListAdapter(Context context, List<SearchEntity.DataBean> list) {
