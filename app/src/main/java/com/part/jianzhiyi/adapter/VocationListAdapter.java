 ...
 * @Date :2020-03-26
 **/
public class VocationListAdapter extends CustomBaseAdapter<JobListResponseEntity2.DataBean> {

    private Context context;

    public VocationListAdapter(Context context, List<JobListResponseEntity2.DataBean> list) {
