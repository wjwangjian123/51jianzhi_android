...
public class TimePickerView extends PickerViewGroup {
    ...
    protected int type = TYPE_HOUR_MINUTE;
    ...
    private int minutesInterval = ONE;
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        minutesInterval = typedArray.getInt(R.styleable.DateTimePickerView_minutesInterval, ONE);
        typedArray.recycle();
    ...
    private void buildViews(Context context) {
        ...
        switch (type) {
            ...
            case TYPE_YEAR_MONTH_DAY_HOUR_MINUTE:
                ...
                yearPickerView.setTextAlign(Layout.Alignment.ALIGN_NORMAL);
                monthPickerView = new PickerView(context);
                dayPickerView = new PickerView(context);
                dayPickerView.setTextAlign(Layout.Alignment.ALIGN_OPPOSITE);
                datePickerView = null;
                hourPickerView = new PickerView(context);
                minutePickerView = new PickerView(context);
                timePickerView = null;
            ...
            case TYPE_HOUR_MINUTE:
                ...
                datePickerView = null;
                hourPickerView = new PickerView(context);
                hourPickerView.setTextAlign(Layout.Alignment.ALIGN_OPPOSITE);
                hourPickerView.disEnablePadding();
                minutePickerView = new PickerView(context);
                minutePickerView.setTextAlign(Layout.Alignment.ALIGN_NORMAL);
                minutePickerView.disEnablePadding();
                timePickerView = null;
                break;
            default:
                yearPickerView = null;
        ...
        if (timePickerView != null) {
            timePickerView.setAdapter(new PickerView.Adapter<TimeItem>() {
                ...
                public TimeItem getItem(int index) {
                    return new TimeItem(TimePickerView.this, index + stepOffset);
                }
            });
        }
    ...
    private static class TimeItem extends CalendarField {
        ...
        private WeakReference<TimePickerView> hostRef;

        TimeItem(TimePickerView host, int stepCount) {
